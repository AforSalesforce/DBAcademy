  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-slate-50 dark:bg-slate-950">
      <header className="h-14 flex items-center justify-between px-4 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 shrink-0 z-10">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 bg-slate-100 dark:bg-slate-800 py-1 px-3 rounded-md border border-slate-200 dark:border-slate-700">
            <label className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Engine:</label>
            <select
              value={dbType}
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Navigation Sidebar */}
        <div className="w-64 flex-shrink-0 flex flex-col border-r border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900">
        ...
        {activeLesson && (
          <div className="flex-1 min-w-[300px] border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 overflow-auto">
            <LessonView
              id={activeLesson.id}
        ...
        <div className="flex-1 min-w-[400px] flex flex-col bg-slate-50 dark:bg-slate-950">
          ...
          <div className="flex-1 relative border-b border-slate-200 dark:border-slate-800">
            <SqlEditor
              value={query}
          ...
          <div className="h-[40%] flex flex-col bg-white dark:bg-slate-900">
