  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-slate-50 dark:bg-slate-950">
      ...
      <div className="flex flex-col md:flex-row flex-1 overflow-y-auto md:overflow-hidden">
        ...
        {activeLesson && (
          <div className="flex-1 w-full md:w-auto min-w-0 md:min-w-[300px] min-h-[500px] md:min-h-0 border-b md:border-b-0 md:border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 overflow-auto">
            <LessonView
              id={activeLesson.id}
        ...
        <div className="flex-1 w-full md:w-auto min-w-0 md:min-w-[400px] flex flex-col min-h-[500px] md:min-h-0 bg-slate-50 dark:bg-slate-950">
